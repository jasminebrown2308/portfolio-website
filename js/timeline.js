  ...
  years: [
    {
      ...
      events: [
        ...
        },
        {
          ...
          description:
            "I was named one of MLH's Top 50 Hackers globally in 2022 (out of 150,000+ hackers worldwide). This was in recognition of my contribution to the hacker community through organising WarwickHACK and leading the WarwickTECH guild at MLH's Global Hack Weeks.",
        },
        {
          month: 6,
          endMonth: 9,
          endYear: 2022,
          category: ["workexp", "jobs"],
          title: "👩‍💼&emsp;Interned as an SDE at Amazon",
          description:
            "I spent this summer as a Software Development Engineer intern at Amazon in London. My role within Prime Video involved designing and implementing an auditing feature to display changes to video subscription offers. I learnt loads of new skills from this project, including TypeScript and React, AWS cloud infrastructure, NoSQL databases, and APIs.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      events: [
        ...
        },
        {
          ...
          description:
            "I worked alongside a designer and web developer to create simple web components such as animated forms and navigation bars using HTML, CSS and basic JavaScript. This was only a week-long experience, but it was super exciting as it was my first taste of web development and working at a tech company.",
        },
      ],
    },
    {
      ...
      events: [
        {
          ...
          description:
            "For my GCSEs, I took Maths (9), Biology (9), Chemistry (9), Physics (9), English Language (8), English Literature (7), Computer Science (9), French (9), Geography (9), Textiles Technology (A*) and Level 2 Further Maths (A^).",
        },
      ],
    },
    {
      ...
      events: [
        {
          ...
          description:
            "Joined my secondary school, where I stayed for 7 years (including sixth form). During my time at Invicta, I was involved in many clubs and activities including music, debating, peer mentoring and Duke of Edinburgh's Awards.",
        },
      ],
    },
    {
      ...
      events: [
        {
          ...
          description:
            "I started learning to play the alto saxophone in primary school. I continued having lessons for over 7 years until I reached Grade 8, and then kept playing in my school orchestra and Big Band where I performed at many concerts and events.",
        },
      ],
    },
    {
      ...
      events: [
        {
          ...
          description:
            "Started learning Ballet, Tap and Modern (and, later on, Pointe) at Directions. This included performing in shows at the Hazlitt Theatre and other events. I also achieved Grade 5 Tap, Ballet and Modern with Distinctions.",
        },
      ],
    },
  ],
...
function categorySelect(clicked) {
  ...
  for (let i = 0; i < 4; i++) {
    if ($("#" + categories[i] + "-checkbox").is(":checked")) {
      // for each category to show, add all
  ...
  for (let y = 0; y < allData.years.length; y++) {
    ...
    for (let e = 0; e < yearData.events.length; e++) {
      ...
      if (
        eventData.category.filter((value) => selectedCategories.includes(value))
          .length > 0
      ) {
...
function showCVData(cvData, showDetails) {
  ...
  for (let y = 0; y < cvData.years.length; y++) {
    ...
    $("#years").append(
      "<div class='year-container'><div class='year' id='year" +
        year +
        "'><h3>" +
        year +
        "</h3></div><div class='content' id='content" +
        year +
        "'></div></div>"
    );
    ...
    for (let e = 0; e < yearData.events.length; e++) {
      ...
      $("#" + year + "_" + e).click(function () {
        if ($("#desc" + year + "_" + e).length) {
          // if description is shown then hide it
          $("#desc" + year + "_" + e).remove();
          $("#dates" + year + "_" + e).remove();
        } else {
          // if description is hidden then show it
          displayDetails(year, e, eventData);
        }
        updateHeight(year);
      });
...
function displayDetails(year, e, eventData) {
  $("#" + year + "_" + e).after(
    "<p class='event-description' id='desc" +
      year +
      "_" +
      e +
      "'>" +
  ...
  if (eventData.endYear != year || eventData.endMonth != eventData.month) {
    $("#" + year + "_" + e).after(
      "<p class='event-dates' id='dates" +
        year +
        "_" +
        e +
        "'>" +
        dateText(eventData.month, year) +
        " - " +
        dateText(eventData.endMonth, eventData.endYear) +
        "</p>"
    );
  } else {
    // if event was only one month
    $("#" + year + "_" + e).after(
      "<p class='event-dates' id='dates" +
        year +
        "_" +
